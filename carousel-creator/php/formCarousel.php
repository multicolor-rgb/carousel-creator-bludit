...
<div class="border helpcontent my-2 mt-3 bg-light p-4">
    ...
    <ul class="p-0" style="list-style-type:square;margin-left:15px;">
        ...
        <li>
            <p>
                <b>6. New!</b> You can use shortcode - paste this code on TinyMCE <code>[% carousel=name %]</code>
            <p>
        </li>
    </ul>
...
<input type=" text" pattern="[A-Za-z0-9]+" required class="form-control placeholder=" title carousel without spacebar and special characters" name="title" <?php
...
<h4>' . ($res->carouseltitle !== "" ? $res->carouseltitle : "Slider item") . '</h4>
 ...
 ';
                        ...
                        echo '<textarea class="carousel-text" id="editor' . $counts . '" name="carouselcontent[]">' . $res->content . '</textarea>
...
tinymce.init({
    selector: "#editor' . $counts . ' ",
    auto_focus: "#editor' . $counts . ' ",
    element_format: "html",
    entity_encoding: "raw",
    skin: "oxide",
    schema: "html5",
...
<script>
    ...
    document.querySelectorAll('.takephoto').forEach((item, index) => {
        ...
        item.addEventListener('click', (e) => {
            e.preventDefault();
            e.preventDefault();
            window.open('<?php echo DOMAIN_ADMIN ?>plugin/carouselcreator?&filebrowser&class=takephoto&index=' + index, "", "width=1200,height=400");
...
<textarea class="carousel-text" id="editor-${counters}" name="carouselcontent[]"></textarea>
    ...
    `
            ...
            tinymce.init({
                selector: '#editor-' + counters,
                auto_focus: '#editor-' + counters,
                element_format: "html",
                entity_encoding: "raw",
                skin: "oxide",
                schema: "html5",
            ...
            document.querySelectorAll('.takephotos').forEach((item, index) => {
                ...
                item.addEventListener('click', (e) => {
                    e.preventDefault();
                    e.preventDefault();
                    window.open('<?php echo DOMAIN_ADMIN;?>plugin/carouselcreator?&filebrowser&class=takephotos&index=' + index, "", "width=1200,height=400");
